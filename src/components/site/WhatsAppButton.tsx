...
export function WhatsAppButton({ phone, brandName }: { phone: string; brandName: string }) {
  ...
  return (
    <a
      ...
      className={`fixed bottom-5 right-5 z-40 grid h-14 w-14 place-items-center rounded-full bg-emerald-500 text-white shadow-[0_12px_30px_-10px_rgba(16,185,129,.8)] transition-all duration-300 hover:bg-emerald-600 ${
